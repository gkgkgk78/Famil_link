...
-- Schema famil_link
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `famil_link` DEFAULT CHARACTER SET utf8mb4 ;
USE `famil_link` ;
...
CREATE TABLE IF NOT EXISTS `famil_link`.`account` (
  ...
  `email` VARCHAR(50) CHARACTER SET 'utf8mb4' NOT NULL COMMENT '이메일',
  `pw` VARCHAR(200) CHARACTER SET 'utf8mb4' NOT NULL COMMENT '비밀번호',
  `address` VARCHAR(100) CHARACTER SET 'utf8mb4' NOT NULL COMMENT '대표주소',
  `phone` VARCHAR(13) CHARACTER SET 'utf8mb4' NOT NULL COMMENT '대표번호',
  `nickname` VARCHAR(100) CHARACTER SET 'utf8mb4' NOT NULL COMMENT '가족별명',
  `role` ENUM('ROLE_USER', 'ROLE_ADMIN') CHARACTER SET 'utf8mb4' NOT NULL DEFAULT 'ROLE_USER' COMMENT '시큐리티',
  `refresh_token` VARCHAR(200) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL,
  `sdate` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '가입일시',
  `salt` VARCHAR(100) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT '개인',
...
CREATE TABLE IF NOT EXISTS `famil_link`.`movie` (
  ...
  `path` VARCHAR(200) CHARACTER SET 'utf8mb4' NOT NULL COMMENT '경로',
  ...
  `status` ENUM('0', '1') CHARACTER SET 'utf8mb4' NOT NULL DEFAULT '0' COMMENT '읽음 여부',
  `public` ENUM('0', '1') CHARACTER SET 'utf8mb4' NOT NULL DEFAULT '0' COMMENT '공개 여부',
  PRIMARY KEY (`uid`),
